...
class Polynomal:
    ...
    # method to calcualte the integral of the given function
    def integration(self, x):
        return np.exp(x) * (np.sin(x) - np.cos(x)) / 2

# Creating the Maclaurin series
p = Polynomal([0, 1, 1, 1 / 3, 0, -1 / 30, -1 / 90, -1 / 630, 0, 1 / 22680, 1 / 113400])
ax = p.area(0, 1/2)
act = p.integration(1/2) - p.integration(0)
e = np.absolute(act - ax)

# Results
print("Approx area:", ax)
print("Actual area:", act)
print("Error:", e)
